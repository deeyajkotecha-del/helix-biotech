...
exports.TARGET_ANALYSES = exports.B7H3_ANALYSIS = exports.TL1A_ANALYSIS = void 0;
exports.getTargetAnalysis = getTargetAnalysis;
// ============================================
// TL1A Target Analysis
// ============================================
exports.TL1A_ANALYSIS = {
    target: 'TL1A',
...
// ============================================
exports.TARGET_ANALYSES = {
    'TL1A': exports.TL1A_ANALYSIS,
    'TNFSF15': exports.TL1A_ANALYSIS,
    'B7-H3': exports.B7H3_ANALYSIS,
    'B7H3': exports.B7H3_ANALYSIS,
    'CD276': exports.B7H3_ANALYSIS,
};
function getTargetAnalysis(target) {
    const normalized = target.toUpperCase().replace(/[-\s]/g, '');
    for (const [key, analysis] of Object.entries(exports.TARGET_ANALYSES)) {
...
//# sourceMappingURL=target-analysis.js.map