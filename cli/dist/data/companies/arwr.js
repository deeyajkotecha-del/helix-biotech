...
exports.ARWR_PRESENTATIONS = exports.ARWR_CATALYSTS = exports.ARWR_CLINICAL_DATA = exports.ARWR_PIPELINE = exports.ARWR_PROFILE = void 0;
exports.getARWRProfile = getARWRProfile;
exports.getARWRPipeline = getARWRPipeline;
exports.getARWRCatalysts = getARWRCatalysts;
exports.getARWRPresentations = getARWRPresentations;
// ============================================
// ARWR Company Profile
// ============================================
exports.ARWR_PROFILE = {
    ticker: 'ARWR',
...
// ============================================
function getARWRProfile() {
    return {
        company: exports.ARWR_PROFILE,
        pipeline: exports.ARWR_PIPELINE,
        clinicalData: exports.ARWR_CLINICAL_DATA,
        catalysts: exports.ARWR_CATALYSTS,
        presentations: exports.ARWR_PRESENTATIONS,
        stats: {
            totalPipelineAssets: exports.ARWR_PIPELINE.length,
            phase3Programs: exports.ARWR_PIPELINE.filter(a => a.phase === 'Phase 3').length,
            approvedProducts: exports.ARWR_PIPELINE.filter(a => a.phase === 'Approved').length,
            partneredPrograms: exports.ARWR_PIPELINE.filter(a => a.partner).length,
            upcomingCatalysts: exports.ARWR_CATALYSTS.filter(c => c.importance === 'high').length,
            totalPresentations: exports.ARWR_PRESENTATIONS.length,
        },
    };
}
function getARWRPipeline() {
    return exports.ARWR_PIPELINE;
}
function getARWRCatalysts() {
    return exports.ARWR_CATALYSTS;
}
function getARWRPresentations() {
    return exports.ARWR_PRESENTATIONS;
}
//# sourceMappingURL=arwr.js.map