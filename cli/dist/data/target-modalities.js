...
exports.DEFAULT_MODALITIES = exports.TARGET_MODALITIES = void 0;
exports.getTargetModalities = getTargetModalities;
exports.hasCuratedModalities = hasCuratedModalities;
exports.getComprehensiveSearchTerms = getComprehensiveSearchTerms;
// ============================================
// Target Modalities Database
// ============================================
exports.TARGET_MODALITIES = {
 ...
 */
function getTargetModalities(target) {
    const normalized = target.toUpperCase().replace(/[-\s]/g, '');
    for (const [key, info] of Object.entries(exports.TARGET_MODALITIES)) {
 ...
 */
function hasCuratedModalities(target) {
    const normalized = target.toUpperCase().replace(/[-\s]/g, '');
    return Object.keys(exports.TARGET_MODALITIES).some(key => key.toUpperCase().replace(/[-\s]/g, '') === normalized);
}
/**
 * Get all search terms for comprehensive target research
 */
function getComprehensiveSearchTerms(target) {
...
//# sourceMappingURL=target-modalities.js.map