...
exports.BIOTECH_ANALYSIS_PROMPT = void 0;
 ...
 */
exports.BIOTECH_ANALYSIS_PROMPT = `You are a senior biotech equity analyst. Analyze this SEC filing and extract key investment-relevant information.
 ...
 */
function buildAnalysisPrompt(filingContent, ticker) {
    return `${exports.BIOTECH_ANALYSIS_PROMPT}
