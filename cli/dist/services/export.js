...
async function generateExcel(reportData) {
    ...
    const targetAnalysis = (0, target_analysis_1.getTargetAnalysis)(reportData.target);
...
// ============================================
function createInvestmentThesisSheet(workbook, analysis) {
...
// ============================================
function createEfficacyComparisonSheet(workbook, analysis) {
...
// ============================================
function createDifferentiatorSheet(workbook, analysis) {
...
// ============================================
function createDealLandscapeSheet(workbook, assets, target) {
