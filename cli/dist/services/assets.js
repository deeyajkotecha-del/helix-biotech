...
exports.extractAssetsFromTrials = extractAssetsFromTrials;
exports.filterAssetsByModality = filterAssetsByModality;
exports.filterAssetsByCompanyType = filterAssetsByCompanyType;
 ...
 */
function extractAssetsFromTrials(trials) {
 ...
 */
function extractGenericName(intervention) {
 ...
 */
function classifyModality(intervention) {
...
function normalizePhase(phase) {
    ...
    if (p.includes('3'))
        return 'Phase 3';
    if (p.includes('2') && p.includes('3'))
        return 'Phase 2/3';
    if (p.includes('2'))
        return 'Phase 2';
    if (p.includes('1') && p.includes('2'))
        return 'Phase 1/2';
    if (p.includes('1'))
        return 'Phase 1';
    if (p.includes('early'))
