...
exports.extractAllPDFs = extractAllPDFs;
exports.extractPipelineFromText = extractPipelineFromText;
exports.extractClinicalResultsFromText = extractClinicalResultsFromText;
exports.extractCatalystsFromText = extractCatalystsFromText;
exports.analyzeDocument = analyzeDocument;
exports.analyzeAllDocuments = analyzeAllDocuments;
exports.getCachedExtraction = getCachedExtraction;
 ...
 */
async function extractAllPDFs(ticker, pdfFiles) {
    const results = [];
    for (const filePath of pdfFiles) {
        const extracted = await extractPDFText(filePath);
        results.push(extracted);
        // Save extracted text
        const extractedDir = (0, pdf_downloader_1.getExtractedDir)(ticker);
        (0, pdf_downloader_1.ensureDir)(extractedDir);
 ...
 */
function extractPipelineFromText(text) {
    const assets = [];
 ...
 */
function extractClinicalResultsFromText(text, source) {
    const results = [];
    // Find efficacy data
 ...
 */
function extractCatalystsFromText(text) {
    const catalysts = [];
 ...
 */
function analyzeDocument(extracted) {
 ...
 */
async function analyzeAllDocuments(ticker, documents) {
 ...
 */
function getCachedExtraction(ticker, documentId) {
    const extractedDir = (0, pdf_downloader_1.getExtractedDir)(ticker);
