...
export const TL1A_DATABASE: TargetAssetDatabase = {
  target: 'TL1A',
...
export const GLP1_DATABASE: TargetAssetDatabase = {
  target: 'GLP-1',
...
export const TARGET_DATABASES: Record<string, TargetAssetDatabase> = {
  ...
  'CD276': B7H3_DATABASE,
  'TL1A': TL1A_DATABASE,
  'TNFSF15': TL1A_DATABASE,
  'TL-1A': TL1A_DATABASE,
  'GLP-1': GLP1_DATABASE,
  'GLP1': GLP1_DATABASE,
  'GLP-1R': GLP1_DATABASE,
  'incretin': GLP1_DATABASE,
};
